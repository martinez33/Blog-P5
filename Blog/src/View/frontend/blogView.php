...
<div class="row">
		...
		<div class="col-lg-8 col-md-10 mx-auto">
			...
			<h2 style="border-bottom: 1px solid black; border-top: 1px solid black; text-align: center">Tous les posts : </h2><br />
			...
			?>
				...
				<div class="posts" style="background-color: #d3d3d3; padding: 10px; margin: 5px;">
					...
					<?php if(!empty($post->getModificationDate())){
                  	?>
			...
			<div class="col-lg-4 col-md-2 mx-auto" >
				<div style="border: 1px solid black; background-color: #778899; border-radius: 10px;  padding: 10px; margin-top: 83px;">
