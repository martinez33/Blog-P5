    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <div class="row" >
              <div class="col-lg-7 col-md-10 mx-auto" >
                  <a href="#" class="thumbnail">
                    <img src="src/Public/images/photoMartin.jpg" alt="Moi" class="img-rounded" style="margin : 25px 5px 25px 5px;">
                  </a>
              </div>
              <div class="col-lg-5" >
                  <p style="margin : 25px 20px 80px -25px; padding: 10px 5px 5px 10px ; background-image: url('src/Public/images/fond.png');">Ce blog (Projet de parcours) met en avant les différentes connaissances acquisent depuis le début de ma formation , en vue d'une prise de contact avec un employeur. <br>Ce blog represente donc le resultat final de ce projet .</p>
              </div>
            </div>
          ...
          <div class="blog-post" >
              ...
              {
              ?>
                <div style="background-color: #d3d3d3; padding: 10px; margin: 5px;">
		...
		<div class="col-lg-4 col-md-2col-sm-3 blog-sidebar">
          ...
          <div class="sidebar-module">
            <a href="src/Public/Forestier_martin.pdf"><img src="src/Public/images/logoCv.png" alt="" style="margin-left: -40px" /></a>
          </div>
        </div><!-- /.blog-sidebar -->
